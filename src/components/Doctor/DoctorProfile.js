					...
					<div className="Doctor-details">
						<Row className="DoctorProfile-details-one">
							<div className="DoctorProfile-list">
								...
								<Row  className="DoctorProfile-row">
									<Col md={12} xs={24}className="DoctorProfile-heading">Phone Number</Col>
									<Col md={12} xs={24}>+91XXXXXXX87</Col>
								</Row>
								<Row  className="DoctorProfile-row">
									<Col md={12} xs={24}className="DoctorProfile-heading">Address</Col>
									<Col md={12} xs={24}>KIET group of institutions Ghaziabad</Col>
								</Row>
								<Row  className="DoctorProfile-row">
									<Col md={12} xs={24}className="DoctorProfile-heading">Hospital</Col>
									<Col md={12} xs={24}>IMS BHU</Col>
								</Row>
								<Row  className="DoctorProfile-row">
									<Col md={12} xs={24}className="DoctorProfile-heading">Hospital Category</Col>
									<Col md={12} xs={24}>L2</Col>
								</Row>
								<Row  className="DoctorProfile-row">
									<Col md={12} xs={24}>
									<a href="/doctorprofile/edit">
									<Button type="primary" htmlType="submit" className="login-form-button DoctorProfile-btn">
										Edit Profile
									</Button>	
									</a>
									</Col>
